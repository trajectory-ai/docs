...
[trajectory](https://trajectoryevals.com) is a SDK that helps you with everything post-building, from tracing to
capu
...
<Steps>
  <Step>
    ...
    You can follow our latest updates via [GitHub](https://github.com/judgmentlabs/judgeval)! If you enjoy using trajectory, consider giving us a star ⭐!
  </Step>
  ...
  <Step>
    ...
    To learn more about using `trajectory`'s tracing module, click [here](/documentation/tracing/introduction).
  </Step>

  <Step>
    ## Start Testing with trajectory

    trajectory enables you to use evals as unit tests in your CI pipelines.
...
Congratulations! You've just finished getting started with `trajectory` and the Judgment Platform.

For a deeper dive into using `trajectory`, learn more about our offerings!
